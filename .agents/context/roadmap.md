...
press, `TAB_MODEL` env pin). This entry remains as the design record.
**Added:** 2026-07-01.
...
**Model per feature (hidden, automatic, via OpenRouter).** Env vars
`TAB_MODEL` / `CMDK_MODEL` / `ANALYSIS_MODEL` - match the model to the job,
