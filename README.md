...
Grant supports Claude Code, Codex, Cursor, ChatGPT, OpenCode, and custom MCP clients. Connected agents can read permitted context and propose or make permitted edits. The first-party CLI remains compatibility-sensitive while its Grant CLI migration is planned.
