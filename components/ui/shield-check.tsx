...
// The checkmark draws itself in on hover (propose = approved by you).
const CHECK_VARIANTS: Variants = {
  ...
  animate: {
    ...
    opacity: [0, 1],
    scale: [0.6, 1],
    transition: { duration: 0.4, opacity: { duration: 0.12 } },
  },
};
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path animate={controls} variants={CHECK_VARIANTS} d="m9 12 2 2 4-4" />
        </svg>
      </div>
    );
  }
