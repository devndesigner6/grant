...
// A plain circle clock whose hands sweep - the same hand animation as the
// HistoryIcon on the activity button, just on a full clock face instead of the
// reset-arrow icon. Controlled via the ref (start/stop) so the save indicator
// can drive it with useAnimatedIconControls.
