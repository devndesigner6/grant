...
// Shared CLI / one-liner command block used across public documentation. Same
  ...
  return (
    ...
    >
      ...
      <AnimatedIconButton
        ...
        className="shrink-0 text-[var(--creed-text-tertiary)] hover:bg-transparent hover:text-[var(--creed-text-primary)]"
        onClick={() => {
